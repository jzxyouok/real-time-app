...
exports.default = {
	...
	methods: {
		fetchFriends: function fetchFriends() {
			...
			this.$http.get('api/friends').then(function (friends) {
				_this.$set('list', friends.json());
			}, function (friends) {
				//error callback
			});
		},
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-d7713078", module.exports)
  } else {
    hotAPI.update("_v-d7713078", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"vue":5,"vue-hot-reload-api":4}],7:[function(require,module,exports){
'use strict';

var _Friends = require('./components/Friends.vue');
...
new Vue({
	...
	components: { Friends: _Friends2.default }, //<friends>
...
},{"./components/Friends.vue":6,"Vue-resource":1,"pusher-js":3,"vue":5}]},{},[7]);
